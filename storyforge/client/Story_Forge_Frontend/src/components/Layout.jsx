...
export default function Layout({ children }) {
  ...
  // Routes that are full-screen immersive experiences — no footer needed
  const isImmersive = ['/gameplay', '/create-story'].includes(currentPath);
  ...
  return (
    <div className="layout-root">
      ...
      {/* Footer — hidden on immersive/full-screen routes */}
      {!isImmersive && (
        <>
